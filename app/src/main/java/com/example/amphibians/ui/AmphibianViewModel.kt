...
class AmphibianViewModel : ViewModel() {
    ...
    private var _status: MutableLiveData<AmphibianApiStatus?> = MutableLiveData()
    val status: LiveData<AmphibianApiStatus?> = _status

    // TODO: Create properties to represent MutableLiveData and LiveData for a list of amphibian objects
    private var _amphibians: MutableLiveData<List<Amphibian?>?> = MutableLiveData()
    ...
    private var _amphibian: MutableLiveData<Amphibian?> = MutableLiveData()
